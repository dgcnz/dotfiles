...
config.bind('<Alt-9>', 'tab-focus --no-last -1')
...
if (platform.system() == 'Darwin'):
    config.bind('<Alt-Shift-p>', 'hint links spawn --detach open -a mpv {hint-url}')
else:
    config.bind('<Alt-Shift-p>', 'hint links spawn --detach mpv  --no-border --force-window yes {hint-url}')
# config.bind('<Alt-Shift-p>', 'hint links spawn  mpv {hint-url}')
